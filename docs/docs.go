    ...
    "paths": {
        ...
        "/auth/google": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Google ID Token Info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "211": {
                        "description": "Successful registration via Google",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/profile/pin": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.SetPINRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "Disable PIN Info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.DisablePINRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/profile/pin/reset": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Reset PIN Info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.ResetPINRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Incorrect answer or invalid PIN",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/user.VerifyPINRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Bad request or incorrect PIN",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/transactions/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated Transaction Info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/wallets/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated Wallet Info",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Conflict - Wallet has associated transactions",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
    ...
    "definitions": {
        ...
        "category.CategoryRequest": {
            ...
            "properties": {
                ...
                "is_active": {
                    "description": "Nullable, defaults to true",
                    "type": "boolean"
                },
                "name": {
                    "type": "string"
                ...
                "parent_id": {
                    "description": "Nullable for parent category",
                    "type": "string"
                },
                "type": {
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "google_id": {
                    "description": "Nullable for Email/Password-only users",
                    "type": "string"
                },
                "has_pin": {
                    "type": "boolean"
        ...
        "models.Wallet": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "CASH, BANK, CREDIT_CARD, E_WALLET, SAVINGS",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
        ...
        "transaction.TransactionRequest": {
            ...
            "properties": {
                ...
                "category_id": {
                    "description": "Optional for TRANSFER",
                    "type": "string"
                },
                "date": {
                    "type": "string"
